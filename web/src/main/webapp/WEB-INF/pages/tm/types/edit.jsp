...
<t:general username = "${username}" ntasks = "${ntasks}" userid = "${userid}">
    <jsp:attribute name="title">
        <title>Edit type | ARTBUREAU</title>
    </jsp:attribute>
    <jsp:body>
        <div class="container">
            <!-- Breadcrumbs line -->
            ...
            <div class="page-header">
                <div class="page-title">
                    <h3>Редактирование направления (Цена/Ставка)</h3>
                </div>
            </div>
            <!-- /Page Header -->
                ...
                <div class="col-md-12">
                    <div class="widget box">
                        <div class="widget-content no-padding">
                            <div class="row">
                                <form:form class="form-horizontal row-border" method="POST" action="${pageContext.request.contextPath}/tm/type/${type.id}" commandName="type">
                                    <div class="form-group">
                                        <div class="col-md-4">
                                            <h5>Название направления</h5>
                                            <form:input path="name" type="text" class="form-control" placeholder="Введите название..."/>

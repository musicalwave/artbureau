        ...
        <div class="container">
            ...
            <div class="crumbs">
                ...
                <ul class="crumb-buttons">
                    <li><a href="${pageContext.request.contextPath}/task" title=""><i class="icon-ok"></i><span>Новое задание</span></a></li>
                    <%--<li class="range">--%>
                        <%--<a href="#">--%>
                ...
                <div class="col-md-12">
                    <div class="widget box">
                        <div class="widget-header">
                            <h4><i class="icon-reorder"></i>Задания [<a href="${pageContext.request.contextPath}/tasks">Все</a>] [<a href="${pageContext.request.contextPath}/tasks/p">Личные</a>] [<a href="${pageContext.request.contextPath}/tasks/g">Групповые</a>]</h4>

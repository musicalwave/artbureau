    ...
    <jsp:body>
        <div class="container">
            ...
            <div class="row">
                <!--=== Example Box ===-->
                <div class="col-md-12">
                    <form:form class="form-horizontal row-border" method="POST" id="validate-1" action="${pageContext.request.contextPath}/call/${clientId}" commandName="call">
                                ...
                                <div class="form-group">
                                    <div class="col-md-12">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-8">
                                                        <form:input type="text" path="clientLname" class="form-control" placeholder="Фамилия" readonly="true"/>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-8">
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <form:input type="text" class="form-control required" path="clientPhone1" data-mask="+7 (999) 999-9999" placeholder="+7 (900) 000-0000" readonly="true"/>
                                                            </div>
                                                            <div class="col-md-6">
                                                                <form:input type="text" class="form-control" path="clientPhone1name" placeholder="Комментарий" readonly="true"/>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                <form:input type="text" path="clientFname" class="form-control required" placeholder="Имя" readonly="true"/>
                                            </div>
                                            <div class="col-md-2"></div>
                                            <div class="col-md-4">
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <form:input type="text" class="form-control" path="clientPhone2" data-mask="+7 (999) 999-9999" placeholder="+7 (900) 000-0000" readonly="true"/>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <form:input type="text" class="form-control" path="clientPhone2name" placeholder="Комментарий" readonly="true"/>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-2"></div>
                                            <div class="col-md-4">
                                                <form:input type="text" path="clientPname" class="form-control" placeholder="Отчество" readonly="true"/>
                                            </div>
                                            <div class="col-md-2"></div>
                                            <div class="col-md-4">
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <form:input type="text" path="clientMail" class="form-control" placeholder="example@mail.ru" readonly="true"/>
                                                    </div>
                        ...
                        <div class="widget box">
                            ...
                            <div class="widget-content">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-10">
                                        <form:select id="call-status-select" path="callStatusId" class="select2-select-00 col-md-10 full-width-fix required">

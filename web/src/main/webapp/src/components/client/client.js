...
import {getClient, updateClient} from '../../actions/client_actions.js';
...
export default React.createClass({
  ...
  updateClientSuccess: function(client) {
  ...
  reloadData: function() {
    getClient(
      this.props.id, 
      client => this.setState(this.clientToState(client)));
  },

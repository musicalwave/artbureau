...
case 2:return"blue"
case 3:return"red"}},getEmptyEvents:function(e,t){return $.ajax({url:"/do/events",data:{teacherId:e.teacherId,roomId:t}})},emptyEventToCalendarEvent:function(e,t){var n=t.add(e.weekday-1,"days").format("YYYY-MM-DD"),o=n+"T"+e.startTime,r=n+"T"+e.finishTime
return{start:o,end:r,rendering:"background",color:"green"}},getEmptyCalendarEvents:function(e,t,n,o){$.when(this.getEmptyEvents(this.state.draggedEvent,this.state.selectedRoomId)).done(function(t){var n=t.map(function(t){return this.emptyEventToCalendarEvent(t,moment(e))}.bind(this))
